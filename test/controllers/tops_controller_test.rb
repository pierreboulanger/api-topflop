...
class TopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create top" do
    assert_difference('Top.count') do
      post tops_url, params: { top: { comment: @top.comment, game_id: @top.game_id, topplayer: @top.topplayer, user_id: @top.user_id } }
    end
  ...
  test "should update top" do
    patch top_url(@top), params: { top: { comment: @top.comment, game_id: @top.game_id, topplayer: @top.topplayer, user_id: @top.user_id } }
